...
sudo sed -i  "s#https://wpsd-swd.w0chp.net/WPSD-SWD/WPSD-Binaries.git#https://github.com/bi7jta/BI7JTA-PiStar-bin_RPi4B.git#g" /usr/local/bin/.git/config #新版WPSD2024 2W
...
sudo sed -i  "s#https://wpsd-swd.w0chp.net/WPSD-SWD/WPSD-Scripts.git#https://github.com/bi7jta/W0CHP-PiStar-sbin_BPiM2.git#g" /usr/local/sbin/.git/config  #新版WPSD2024 2W
...
sudo sed -i  "s#https://wpsd-swd.w0chp.net/WPSD-SWD/WPSD-WebCode.git#https://github.com/bi7jta/W0CHP-PiStar-Dash_BPiM2.git#g" /var/www/dashboard/.git/config #新版WPSD2024 2W
